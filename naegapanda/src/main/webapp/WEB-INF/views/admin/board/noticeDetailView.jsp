...
<body>
	...
	<c:import url="../../common/admin.jsp"/> 
					...
					<div class="col-lg-7">
						...
						<form encType="multipart/form-data" method="post" >
							...
							<div class="mb-3">
								...
								<c:if test="${!empty n.nOriginalFileName }">
									<a href="${ contextPath }/resources/nupload/${ n.nRenameFileName}" downloand="${ n.nOriginalFileName }">${ n.nOriginalFileName }</a>
								</c:if>
						...
						<div align="center">
							<button type="button" class="btn" onclick="location.href='nupView.do';">수정하기</button>
							&nbsp; &nbsp;
							<button type="button" class="btn" onclick="location.href='ndelete.do';">삭제하기</button>
						</div>
					</div>
