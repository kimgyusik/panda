...
<table class="table table-hover">
						...
						<tbody>
									...
									<tr>
										<td align="center">
											<a href="${ svdetaillist }">${sv.sNo}</a>
										</td>
										<td align="center">
											<a href="${ svdetaillist }">${sv.sName}</a>
										</td>
										<td align="center">
											<a href="${ svdetaillist }">${sv.storeName}</a>
										</td>
										<td align="center">
											<a href="${ svdetaillist }">${sv.sViolate}</a>
										</td>
										<td align="center">
											<a href="${ svdetaillist }">${sv.vDate}</a>
										</td>
										<td align="center">
											<a href="${ svdetaillist }">${sv.sStatus}</a>
										</td>
						...
						<tr align="center" height="20">
							<td colspan="6">
								...
								<c:if test="${ pi.currentPage ne 1 }">
									<c:url value="sViolateList.do" var="before">
