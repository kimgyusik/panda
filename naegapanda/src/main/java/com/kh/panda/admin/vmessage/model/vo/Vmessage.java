...
public class Vmessage {
	...
	public Vmessage(int vmNo, int vNo, int sNo, String sName, int pId, String pName, String vmTitle, String vmContent,
	...
	public String toString() {
		return "Vmessage [vmNo=" + vmNo + ", vNo=" + vNo + ", sNo=" + sNo + ", sName=" + sName + ", pId=" + pId
				+ ", pName=" + pName + ", vmTitle=" + vmTitle + ", vmContent=" + vmContent + ", vmSendDate="
				+ vmSendDate + ", vmCheckDate=" + vmCheckDate + ", vmOriginalFileName=" + vmOriginalFileName
				+ ", vmRenameFileName=" + vmRenameFileName + ", vmStatus=" + vmStatus + "]";
	}
