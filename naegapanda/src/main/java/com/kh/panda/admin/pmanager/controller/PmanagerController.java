...
public class PmanagerController {
	...
	public ModelAndView selectList(ModelAndView mv, String cName2, 
		...
		int listCount1 = pmService.getListCount1();
		int listCount2 = pmService.getListCount2();
		
		PageInfo pi = Pagination.getPageInfo(currentPage, listCount1);
		PageInfo pi2 = Pagination.getPageInfo2(currentPage2, listCount2);
